...
const products: Array<Product> = [
  {
    ...
    description: "An Autonomous Text Localisation engine that can make any website available in 150+ different languages. Currently, developing the harness layer of our AI. Our Enterprise offering includes more reliable text localisation and deep integration with their products",
    status: "Beta",
    tech: ["Go", "Google ADK"],
